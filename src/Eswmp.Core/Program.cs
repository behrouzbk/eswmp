...
builder.Host.UseSerilog((ctx, lc) => lc
    ...
    .Enrich.WithProperty("Service", "Core")
    .WriteTo.Console());
...
// ── Domain services ───────────────────────────────────────────
builder.Services.AddSingleton<SlotOptimizer>();
builder.Services.AddSingleton<ReservationDurationEstimator>();
...
builder.Services.AddHealthChecks()
    .AddDbContextCheck<CoreDbContext>("db", tags: ["ready"])
