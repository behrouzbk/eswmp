...
builder.Host.UseSerilog((ctx, lc) => lc
    ...
    .Enrich.WithProperty("Service", "Rules")
    .WriteTo.Console());
...
// ── Domain services ───────────────────────────────────────────
builder.Services.AddSingleton<WorkflowTransitionValidator>();
...
builder.Services.AddHealthChecks()
    .AddDbContextCheck<RulesDbContext>("db", tags: ["ready"])
